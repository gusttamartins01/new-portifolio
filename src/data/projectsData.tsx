...
export const projects: Project[] = [

  {
    ...
    tech: ["TypeScrip", "Node.JS", "React", "npm", "Vite", "API", "TailwindCSS", "Postgres", "Python", "React Native", "N8N"],
  ...
  {
    id: 2,
    title: "Projeto Meu Primeiro 'Trampo' ",
    description: "Sistema desenvolvido para dar suporte aos alunos do fundamental II e ensino médio, e para as pessoas que desejam entrar ou se realocar no mercado de trabalho.",
    tech: ["TypeScrip", "Node.JS", "React", "npm", "Vite", "API", "TailwindCSS"],
    image: "/assetes/primeirotrampo.png",
  ...
  },
  {
    ...
    tech: ["TypeScrip", "Node.JS", "React", "npm", "Vite", "TailwindCSS", "SupaBase"],
  ...
  {
    id: 4,
    title: "Projeto Players and Transactions",
    description: "Sistema para mensurar número de jogadores, transições e resultados  do ticked médio de valores.",
    tech: ["TypeScrip", "Node.JS", "React", "Python", "npm", "Docker", "MySQL", "API"],
...

  {
    ...
    tech: ["TypeScrip", "Node.JS", "React", "npm", "Vite", "Tailwind", "PostgresSQL"],
  ...
  },
  {
    ...
    description: "Dashboard interativo paara acompanhar rorinas diarias.",
    tech: ["Python", "HTML5", "CSS3", "JSON", "Autenticação com Banco de Dados Mockado "],
  ...
  },
  {
    ...
    tech: ["N8N", "JavaScript", "JSON", "PostgresSQL", "Autenticação com banco de dados"],
    image: "/assetes/n8n.png",
  },
  {
    id: 9,
    title: "Projeto de automação de respostas de e-mail com Python",
    description: "Classificando e-mails (produtivo e improdutivo) e automatizando respostas com agente de IA.",
    tech: ["Python", "JavaScript", "Node.JS", "npm", "JSON", "HTML", "CSS"],
  ...
  },
  {
    ...
    description: "Página web para vizualizar atividades atrasadas e enviar mensagem automaticas pelo whatsapp notificando ás atividades entregas, pendetes e atrasadas.",
